...
export function setupV1Router(prismaClient: PrismaClient): Router {
    ...
    v1Router.get('/docs', (_, res) => res.sendFile("redoc-static.html", { root: "C:/Users/Default.DESKTOP-IFHGSV5/Documents/Code/compilation-website-server" }))
    v1Router.get('/openapi', (_, res) => res.sendFile("openapi-v1.yaml", { root: "C:/Users/Default.DESKTOP-IFHGSV5/Documents/Code/compilation-website-server" }))
